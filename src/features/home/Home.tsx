        ...
        <div className="Home__intro flex-column-center">
          <WidthMonitor>
            ...
            <span className="align-center">
              ...
              <Button onClick={() => openPage("https://github.com/talmage89")}>
                Github
              </Button>
            </span>
          </WidthMonitor>
        ...
        <div className="Home__about flex-column-center">
          <WidthMonitor className="flex-space-between">
            <div>
              ...
              <p>
                I'm a frontend developer at Start Studio, a software development
                team based in Utah. I work with React, Angular, and Flutter to
              ...
              <p>
                ...
                about computer networking and studying for the CompTIA Network+
                certification.
              </p>
              <p>
